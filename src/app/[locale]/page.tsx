...
export default function Home() {
  ...
  const fetchReviews = async () => {
    try {
      ...
      setAnimeReviews(animeResponse.ok ? await animeResponse.json() : []);
      setMangaReviews(mangaResponse.ok ? await mangaResponse.json() : []);
    } catch (error) {
  ...
  const animeMangaReviews = [...animeReviews, ...mangaReviews];
